...
<MobileElementEntity>
   ...
   <tag></tag>
   <elementGuidId>7653ef5c-dd72-4aa2-800a-75a072e5b95a</elementGuidId>
   ...
   <locator>//*[@class = 'android.widget.TextView' and (contains(@text, '${text}') or contains(., '${text}'))]</locator>
